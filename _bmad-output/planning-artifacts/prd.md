...
Data comes directly from BMAD artifacts (YAML/JSON/Markdown), ensuring always-accurate status. Unlike Jira where data is stale because developers forget to update it, bmad-ui reads the single source of truth. Product owners open the board and think: _"This is the truth."_
...
A message appears: _"bmad-ui running at http://localhost:3000"_
...
She thinks: _"I finally trust what I see."_
